...
<body>
        ...
        <div class="container pt-5 pb-3">
            ...
            <div class="row align-items-center pb-2">
                ...
                <div class="col-lg-6 mb-4">
                    ...
                    <p><?php echo $bio;?></p>
                    <a class="btn btn-primary px-3" href="car_details.php?id=<?php echo $id; ?>">More Details</a>
                    <a class="btn btn-primary px-3" href="#booking">Booking Now</a>
                </div>
            </div>
    ...
    <div class="container-fluid pb-5">
        <div class="container">
            <div>
                <form method="post" action="checkout.php?id=<?php echo $id;?>#check">
                    <div class="col-lg-8">
                        ...
                        <div class="mb-5">
                            <div class="row">
                                <div class="col-6 form-group">
                                    ...
                                    <option selected value="1">Cairo-Helwan</option>
                            ...
                            <div class="row">
                                <div class="col-6 form-group">
                                    <div class="date" id="date1" data-target-input="nearest">
                                        <input type="date" name="date" class="form-control p-4 datetimepicker-input" placeholder="Pickup Date"
                                            min="<?php echo"$vailable_day";?>" required/>
                                    </div>
                                </div>
                                <div class="col-6 form-group">
                                    <select required placeholder="Pickup Date" name="days" class="custom-select px-4" style="height: 50px;">
                                        <option disabled selected value="">Rent Days</option>
                                        <?php
                                            for ($i = 1; $i <= 30; $i++): ?>
                            ...
                            <div class="form-group">
                                <textarea class="form-control py-3 px-4" name="special_request" rows="3" placeholder="Special Request" ></textarea>
                            </div>
                    ...
                    <div class="col-lg-4 col-lg-8">
                        <div class="bg-secondary p-5 mb-5">
                            <button type="submit" name="done" class="btn btn-block btn-primary py-3">Reserve Now</button>
                        </div>;
                    </div>
                </form>
